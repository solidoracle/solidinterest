...
import {UUPSProxiable} from "./Interfaces/superfluid/upgradability/UUPSProxiable.sol";
...
import {ISquareSuperToken} from "./Interfaces/superfluid/ISquareSuperToken.sol";

import {ISuperfluidToken, SquareSuperfluidToken} from "./Interfaces/superfluid/SquareSuperfluidToken.sol";

import {ERC777Helper} from "./Interfaces/superfluid/libs/ERC777Helper.sol";
 ...
 * @author Superfluid
 */
contract StIbSquare is
    PausableUpgradeable,
    AccessControlUpgradeable,
    UUPSUpgradeable,
    SquareSuperfluidToken,
    ISquareSuperToken
{
    ...
    function squareInitialize(
        ...
        initializer // OpenZeppelin Initializable
    {
        SquareSuperfluidToken._host = ISuperfluid(host);
        SquareSuperfluidToken._underlying = IERC20(underlyingToken);
    ...
    /**************************************************************************
     * Square custom functions
     *************************************************************************/
    // //@dev Square custom functions"

    /// @notice Force unwraps tokens to ibSquares
    ...
    /// @param amount Amount of StIbSquares to unwrap.
    function squareWithdraw(
        address account,
        uint256 amount
    ...
    function _move(
        ...
        SquareSuperfluidToken._move(from, to, amount.toInt256());
    ...
    function _mint(
        ...
        SquareSuperfluidToken._mint(account, amount);
    ...
    function _burn(
        ...
        SquareSuperfluidToken._burn(from, amount);
    ...
    function _authorizeUpgrade(
        ...
        require(upgradeStatus, "IbSquare: Upgrade not allowed");
        upgradeStatus = false;
    }
